 ...
 */
-(instancetype _Nonnull) init __attribute__((unavailable("Please use `[GLMapVectorCascadeStyle createStyle:]` or `[GLMapVectorCascadeStyle createStyle:error:]`")));
...
/**
 ...
 @return New `GLMapVectorCascadeStyle` object
 */
+(instancetype _Nullable) createStyle:(NSString *_Nonnull)style error:(NSError **)error;
