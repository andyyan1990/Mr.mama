...
-(instancetype _Nonnull) init __attribute__((unavailable("Please use `[GLSearchCategories initWithPath:]` instead.")));

/**
 Sets path where ICU can find 'icudtXXl.dat' file with collation information.
 */
+(void) setCollationDataLocation:(NSString *_Nonnull)path;
